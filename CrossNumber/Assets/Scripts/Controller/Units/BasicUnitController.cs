...
public class BasicUnitController : MonoBehaviour {
    ...
    {
        GetComponent<UnitController>().SetValue(value);
    ...
    public static UnitController ObjectCheck(Vector3 pos, int layerValue)
    {
    ...
    public static UnitController ObjectCheck(Vector3 pos)
    {
        UnitController unit = default;
